 ...
 * behaves somewhat differently from other <tt>Map</tt> implementations.
 * 
 * <p>
 ...
 * may be constructed using the {@link Collections#synchronizedMap Collections.synchronizedMap}
 * method.
 * 
 * <p>
 ...
 * way to deal with this is to wrap values themselves within <tt>SoftReferences</tt> before
 * inserting, as in: <tt>m.put(key, new SoftReference(value))</tt>, and then unwrapping upon each
 * <tt>get</tt>.
 * 
 * <p>
 ...
 * @version create on 2017年11月10日 下午11:50:43
 */
