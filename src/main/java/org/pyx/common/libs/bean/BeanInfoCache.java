...
import org.pyx.common.libs.core.ConcurrentCache;
import org.pyx.common.libs.able.Computable;
import org.pyx.common.libs.core.LoggerSupport;
import org.pyx.common.libs.util.ExceptionUtil;
...
public class BeanInfoCache extends LoggerSupport {
    ...
    public BeanInfo getBeanInfo(Class<?> beanClass) {
        try {
            ...
            log.error("Introspector.getBeanInfo {} error", e, beanClass);
    ...
    public Map<String, PropertyDescriptor> getPropertyDescriptor(final Class<?> beanClass) {
        Map<String, PropertyDescriptor> propMap = getPropertyMap(beanClass, null);
     ...
     * @param beanClass bean类型
     * @param stopClass 停止加载的父类型
     * @return bean属性描述符映射表 @MethodDescriptor
     */
